...
public class About {
    ...
    public void me() {
        ...
        contentText =
        "<html><body><p>" +
        "Author: Victor Otieno<br />" +
        "Contact me at: " +
        "<a href='mailto:" + SimpleJavaTextEditor.AUTHOR_EMAIL + "?subject=About the NotePad Software'>" + SimpleJavaTextEditor.AUTHOR_EMAIL + "</a>" +
                "<br /><br />" +
                "Modified By: Victor Otieno<br />" +
